...
func (q *Queries) ListDays(ctx context.Context, arg ListDaysParams) ([]DailyMetric, error) {
	...
	for rows.Next() {
		var i DailyMetric
		if err := rows.Scan(
			&i.DayKey, &i.Steps, &i.PaiScore, &i.Readiness, &i.Spo2Avg, &i.HrvRmssd,
			&i.RestingHr, &i.MaxHr, &i.RespRateAvg, &i.StressAvg, &i.SleepScore, &i.SleepMins,
			&i.SleepDeepMins, &i.SleepRemMins, &i.SleepLightMins, &i.TempAvgC,
			&i.NapCount, &i.WorkoutCount, &i.ActivitySessionCount, &i.UpdatedAt,
		); err != nil {
			return nil, err
		}
...
func (q *Queries) UpsertDayMetric(ctx context.Context, arg UpsertDayMetricParams) error {
	_, err := q.db.Exec(ctx, upsertDayMetric,
		arg.DayKey, arg.Steps, arg.PaiScore, arg.Readiness, arg.Spo2Avg,
		arg.HrvRmssd, arg.RestingHr, arg.MaxHr, arg.RespRateAvg, arg.StressAvg,
		arg.SleepScore, arg.SleepMins, arg.SleepDeepMins, arg.SleepRemMins, arg.SleepLightMins,
		arg.TempAvgC, arg.NapCount, arg.WorkoutCount, arg.ActivitySessionCount, arg.SourceSessionID,
	)
	return err
}
